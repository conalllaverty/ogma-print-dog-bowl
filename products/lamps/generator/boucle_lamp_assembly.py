...
Run from the repository root:
    ...
    .venv/bin/python products/lamps/generator/boucle_lamp_assembly.py --out products/lamps/boucle-stack-lamp/assembly
"""
...
def write_project(
    ...
    preview_path = assets.PLATE_PREVIEWS / "cooper_base_plate.3mf"
    with (
